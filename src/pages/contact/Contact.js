            ...
            <div className='my-2 md:w-1/2'>
                <form ref={form} onSubmit={sendEmail} className='flex flex-col'>
                    ...
                    <div class='flex items-center'>
                        <button
                            type='submit'
                            class='relative inline-flex items-center px-4 py-2 leading-6 text-white transition delay-150 ease-in-out hover:-translate-y-1 hover:scale-110 bg-primary-default rounded-md shadow hover:bg-primary-dark duration-300'
                            disabled=''
                        >
